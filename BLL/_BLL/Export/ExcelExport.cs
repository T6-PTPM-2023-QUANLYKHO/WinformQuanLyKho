...
namespace _BLL.Export
{
    public class ExcelExport
    {
        ...
        private void BuildReplacerCurrentDate(ref Dictionary<string, string> pReplacer, EXPhieuXuatModel model)
        {
            if (pReplacer != null)
            {
                ...
                pReplacer.Add("%MaKH", model.MaKH);
                pReplacer.Add("%HoTenKH", model.HoTenKH);
                pReplacer.Add("%DiaChi", model.DiaChiKH);
                pReplacer.Add("%Sdt", model.Sdt);
                pReplacer.Add("%TongTien", model.TongTien);
                pReplacer.Add("%HoTenNV", model.HoTenNV);
                pReplacer.Add("%SoDienThoaiNV", model.SoDienThoaiNV);
                pReplacer.Add("%TongTienBangChu", model.TongTienBangChu);
            }
        }
        ...
        public bool ExportPhieuXuat(EXPhieuXuatModel dataSourceKH, List<CT_TT_PhieuXuatExport> dataSource, ref string fileName, bool isPrintPreview)
        {
            // Check if data is null
